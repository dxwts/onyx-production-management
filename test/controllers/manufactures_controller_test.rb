...
class ManufacturesControllerTest < ActionController::TestCase
  ...
  test "should create manufacture" do
    assert_difference('Manufacture.count') do
      post :create, manufacture: { address: @manufacture.address, name: @manufacture.name, remark: @manufacture.remark, tel: @manufacture.tel }
    end
  ...
  test "should update manufacture" do
    patch :update, id: @manufacture, manufacture: { address: @manufacture.address, name: @manufacture.name, remark: @manufacture.remark, tel: @manufacture.tel }
    assert_redirected_to manufacture_path(assigns(:manufacture))
  end
