class Materiale
  ...
  has_many :materiale_pics, :dependent => :destroy
  accepts_nested_attributes_for :datasheets, :acknowledgements, :materiale_manufacture_ships, :materiale_pics, :allow_destroy => true
